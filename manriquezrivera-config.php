<?php
/**
 * Plugin Name: Manríquez Rivera - Configuración
 * Description: Configuración personalizada para el sitio de Manríquez Rivera (Custom Post Types, Taxonomías, REST API)
 * Version: 1.0
 * Author: Tu Nombre
 */
